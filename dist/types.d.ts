...
export type AnnotSubtype = 'Ink' | 'FreeText' | 'Line' | 'PolyLine' | 'Polygon' | 'Circle' | 'Square' | 'Highlight';
/** /IT intent values recognised by Bluebeam and Acrobat. */
export type AnnotIntent = 'FreeTextCallout' | 'FreeTextTypeWriter' | 'LineDimension' | 'LineArrow' | 'PolygonCloud' | 'PolyLineDimension';
/**
